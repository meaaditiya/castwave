    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-1 bg-muted/40">
                <div className="w-full max-w-2xl mx-auto py-12 px-2 sm:px-4">
                     <Card>
                        ...
                        <CardContent className="pt-6 space-y-6">
                             <div>
                                ...
                                <div className="flex flex-col sm:flex-row gap-2 rounded-md border p-4">
                                    ...
                                    <div className="flex-1"> 
                                        <Button onClick={handleGenerateAvatar} disabled={isGeneratingAvatar || !currentUser.profile?.username} className="w-full">
